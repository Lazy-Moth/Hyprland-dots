...
swww img "$THEME_DIR/wallpaper.jpg" --transition-type random --transition-fps 60 --transition-step 255 > /dev/null 2>&1
echo ""
...
cp "$THEME_DIR/nvim/chadrc.lua" "$HOME/.config/nvim/lua/chadrc.lua" > /dev/null 2>&1
echo ""