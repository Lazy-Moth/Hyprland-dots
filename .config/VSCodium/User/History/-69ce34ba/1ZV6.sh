...
entry {
    ...
    text-color: @foreground;
    padding: 4px 0;         /* явные верх/низ отступы для центровки каретки */
    /* попробуй раскомментировать/подогнать, если нужно:
       font: "Operator Mono 12";
       line-height: 1.0;
    */
}
...
entry-text {
    vertical-align: 0.5;    /* центр по вертикали */
    horizontal-align: 0.0;  /* привязка к левому краю */
    padding: 2px 0 0 0;     /* небольшой верхний отступ — поднимает текст и caret */
}
