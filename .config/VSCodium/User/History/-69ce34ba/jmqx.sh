...
element {
    padding: 14px 14px 18px 14px;      /* нижний отступ для выравнивания текста */
    border-radius: 99999px;               /* закругление со всех сторон */
    background-color: transparent;
    text-color: #bac2de;
}
...
element selected {
    ...
    border-radius: 12px;               /* обязательно для округления фона */
    text-color: #89b4fa;
}
